...
any MCP client (works where MCP resources are unsupported). These are the only
tools this otherwise resource-only MCP exposes — no domain tools."""

from fastmcp.tools import tool

from src.config import settings
from src.fs import MAX_READ_BYTES, PROJECT_ROOT, resolve_within_roots
